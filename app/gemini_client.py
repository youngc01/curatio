...
class GeminiTaggingEngine:
    ...
    def __init__(self, api_key: str = None, model_name: str = None):
        ...
        # Tag categories
        self.tag_categories = {
            "genre": ["Action", "Crime", "Sci-Fi", "Horror", "Drama", "Comedy", "Thriller", "Romance", "Fantasy", "Mystery", "Documentary", "Animation"],
            "mood": ["Dark", "Gritty", "Feel-Good", "Quirky", "Suspenseful", "Witty", "Heartwarming", "Intense", "Cerebral", "Lighthearted"],
            "era": ["1920s", "1930s", "1940s", "1950s", "1960s", "1970s", "1980s", "1990s", "2000s", "2010s", "2020s"],
            "region": ["British", "Korean", "French", "Scandinavian", "Japanese", "Italian", "Spanish", "Latin American", "Indian", "Chinese"],
            "plot": ["Heist", "Time Travel", "Revenge", "Courtroom", "Found Footage", "Coming-of-Age", "Survival", "Conspiracy", "Detective"],
            "style": ["Neo-Noir", "Arthouse", "Independent", "Cyberpunk", "Visually Stunning", "Minimalist", "Period Costume", "Neon Visuals"],
            "character": ["Strong Female Lead", "Anti-Hero", "Ensemble Cast", "Character Study", "Underdog", "Morally Ambiguous"]
        }
...
"""
    ...
    async def analyze_user_taste(self, watched_items: List[Dict]) -> Dict:
        ...
        prompt = f"""You are analyzing a user's viewing history to understand their taste in movies and TV shows.
...
"""
        ...
        try:
            ...
            logger.info(f"Analyzed user taste: {len(result.get('patterns', []))} patterns found")
